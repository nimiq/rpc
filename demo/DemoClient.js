class DemoClient {
    constructor() {
        ...
        this._redirectClient = new RpcClient.RedirectRpcClient('second.html', DemoClient.DEMO_ORIGIN);
    ...
    async _startIFrame() {
        ...
        this._iframeClient = new RpcClient.PostMessageRpcClient($iframe.contentWindow, DemoClient.DEMO_ORIGIN);
    ...
    async _startPopup(requestName, ...args) {
        ...
        const rpcClient = new RpcClient.PostMessageRpcClient($popup, DemoClient.DEMO_ORIGIN);
